...
<div id="main">
    ...
    <!-- Wrap Block Content -->
        ...
        <div class="left_part">
                        	...
                        	<h3>Thanks you !</h3>
                            <p class="biglines">Your message has been sent ! We send back to you a confirmation mail at your email : <?php echo $_GET['mail']; ?> in few seconds... <br />
        And answer at your message in few moment !<br />
           You can send another message if you want...</p>
<form action="sendmail.php" method="post" id="reply-form">
							...
							if($_GET['doh'] == "error") 
								$error = '<label class="error">Oops... Retry !</label>';
									...
									echo '<input type="hidden" name="1" value="'.$n1.'" class="field" />';
									echo '<input type="hidden" name="2" value="'.$n2.'" class="field" /><br/>';
